...
elif view_mode in STAT_COLORS or view_mode == "STAT_LEDGER":
    selected_stat = st.session_state.get("selected_stat", view_mode if view_mode in STAT_COLORS else "Discipline")
